    ...
    while queue:
        ...
        for dx, dy in directions:
            ...
            if 0 <= nx < len(maze) and 0 <= ny < len(maze[0]):
                ...
                if not maze[nx][ny] and (
                    not visited_with_wall[nx][ny]
                    if is_wall_removed
                    else not visited_without_wall[nx][ny]
                ):
                ...
                # If next cell is a wall and we haven't removed any wall yet
                    ...
                    maze[nx][ny]
                    and not is_wall_removed
                    and not visited_with_wall[nx][ny]
                ):
